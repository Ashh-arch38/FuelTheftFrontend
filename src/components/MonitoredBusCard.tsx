...
import { AlertTriangle, WifiOff, CheckCircle, AlertCircle } from "lucide-react";
    ...
    >
      ...
      <div className="flex flex-col justify-between p-4 h-full flex-1">
        ...
        <div className="flex justify-between items-center mt-3">
          ...
          <div className={`px-2 py-1 text-[10px] rounded-full font-bold uppercase flex items-center gap-1 ${getStatusBadge()}`}>
            {getStatusIcon()}
            {getStatusText()}
          </div>
        </div>
